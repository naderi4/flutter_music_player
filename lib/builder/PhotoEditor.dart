...
class PhotoEditor extends StatefulWidget {
  PhotoEditor({Key? key, required this.imageURL}) : super(key: key);
...
class _PhotoEditor extends State<PhotoEditor> {
  ...
  void initBackground() async {
    ...
    //final image = await NetworkImage(widget.imageEditLink).image;

    //imageCache.clear();
    //var bytes = File(widget.imageURL).readAsBytesSync();
    //Image image = Image.memory(bytes);
    //imageCache.clearLiveImages();

    final image = await FileImage(File(widget.imageURL)).image;
  ...
  Future<void> renderAndDisplayImage() async {
    ...
    final buffer = await imageFuture;
